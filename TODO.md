...
Chantiers à venir, par outil. Estimation : **S** ≈ moins d'une heure, **M** ≈ une demi-journée, **L** ≈ une journée ou plus.
...
- [ ] **Sélecteur de palier façon « recettes alternatives »** — **M**
...
- [ ] **Retirer le filtre « Minerai neuf »** — **S**
...
- [ ] **Renommer « Chaîne déjà payée »** — **S**
  Libellé peu parlant (`sortC`, `chainCovered`, `mChainCovered`). Trouver un nom clair en FR et en EN, le reporter dans le tri, la colonne, la fiche détail et l'aide. Le plus gros du temps est de trancher la formulation avec le joueur.

Entrée de journal à prévoir pour le broyeur (une seule version regroupant les trois points).
